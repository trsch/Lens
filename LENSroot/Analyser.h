...
public :
   ...
   Int_t           nNot6417;
   Int_t           nTotal;
   Float_t         C0[14];   //[nHitsChnl0]
   Float_t         C1[17];   //[nHitsChnl1]
   Float_t         C2[16];   //[nHitsChnl2]
   Float_t         C3[16];   //[nHitsChnl3]
   Float_t         C4[16];   //[nHitsChnl4]
   Float_t         C5[1];   //[nHitsChnl5]
   Float_t         C6[1];   //[nHitsChnl6]
   Float_t         C7[1];   //[nHitsChnl7]
   Float_t         C8[7];   //[nHitsChnl8]
   Float_t         C9[68];   //[nHitsChnl9]
   Float_t         C10[3];   //[nHitsChnl10]
   Float_t         C11[3];   //[nHitsChnl11]
   Float_t         C12[11];   //[nHitsChnl12]
   Float_t         C13[4];   //[nHitsChnl13]
   Float_t         C14[1];   //[nHitsChnl14]
   Float_t         C15[1];   //[nHitsChnl15]
   Float_t         CNot64[14];   //[nHitsChnl17]
   Int_t           CNot64Pxl1[14];   //[nHitsChnl17]
   Int_t           CNot64Pxl2[14];   //[nHitsChnl17]
   UInt_t          BNL105FrameIndex;
   Int_t           nBNL;
   Float_t         BNL[144];   //[nHitsChnl16]
   Float_t         BNLx[144];   //[nHitsChnl16]
   Float_t         BNLy[144];   //[nHitsChnl16]
   ...
   Float_t         PulseVector[626];   //[PulseVectorLength]
   Int_t           PulseVectorIndex[626];   //[PulseVectorLength]
   Double_t        AproxTime;
